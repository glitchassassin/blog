	...
	return (
		<header className="mb-16 border-b border-amber-300 pb-8 dark:border-zinc-700">
			<div className="flex flex-col items-center md:flex-row md:items-end md:gap-12">
				...
				<aside className="mb-6 flex flex-row items-center gap-4 md:order-2 md:mb-0 md:flex-col">
					{/* Profile Photo */}
					<div className="relative">
						<Link
							to="/curriculum-vitae"
							aria-label="View Jon Winsley's profile and Curriculum Vitae"
							className="rounded-full focus:outline-2 focus:outline-offset-50 focus:outline-amber-500 dark:focus:outline-amber-400"
						>
							<img
								src="/assets/images/profile_300.jpeg"
								alt="Jon Winsley's profile photo"
					...
					>
						<Link
							...
							className="rounded text-amber-900 hover:text-amber-700 focus:text-amber-700 focus:outline-2 focus:outline-offset-2 focus:outline-amber-500 dark:text-stone-300 dark:hover:text-stone-100 dark:focus:text-stone-100 dark:focus:outline-amber-400"
							aria-label="Visit Jon's GitHub profile (opens in new tab)"
						>
							<svg
								className="h-8 w-8"
								fill="currentColor"
						...
						<Link
							...
							rel="noopener noreferrer"
							className="rounded text-amber-900 hover:text-amber-700 focus:text-amber-700 focus:outline-2 focus:outline-offset-2 focus:outline-amber-500 dark:text-stone-300 dark:hover:text-stone-100 dark:focus:text-stone-100 dark:focus:outline-amber-400"
							aria-label="Join the Covenant Foundry Discord server (opens in new tab)"
						>
							<svg
								className="h-8 w-8"
								fill="currentColor"
				...
				<div className="flex-1 md:order-1">
					...
					<div className="mb-6">
						...
						<nav
							...
							className="mt-4 flex items-center gap-4 font-mono text-sm text-amber-700 dark:text-amber-300"
						>
							<Link
								to="/curriculum-vitae"
								className="rounded font-medium hover:text-amber-900 focus:text-amber-900 focus:outline-2 focus:outline-offset-2 focus:outline-amber-500 dark:hover:text-amber-100 dark:focus:text-amber-100 dark:focus:outline-amber-400"
							>
								Curriculum Vitae
							</Link>
