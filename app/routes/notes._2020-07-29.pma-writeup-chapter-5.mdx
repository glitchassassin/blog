...
date: July 30, 2020
excerpt: My analysis of the disassembly labs in Chapter 5 of "Practical Malware Analysis".
...
![Graph of cross-references from sub_10004E79](/assets/images/pma-5-1-1.png)
...
![Symbolic constants AF_INET, SOCK_STREAM, and IPPROTO_TCP respectively](/assets/images/pma-5-1-2.png)
