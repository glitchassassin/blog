...
![A chart displaying history of spawn energy levels](/assets/images/screeps-reports-metrics-1.png)
...
![Extensions layout](/assets/images/screeps-spawn-uptime-1.png)
...
After watching these metrics for a while, the throughput and income are _generally_ aligned:

![Throughput slightly lower than income](/assets/images/screeps-spawn-uptime-2.png)
...
const workPartsPerSalesman = Math.min(
	5,
	Math.floor((Game.rooms[this.office.name].energyCapacityAvailable - 50) / 100),
)
...
![Throughput slightly lower than income](/assets/images/screeps-spawn-uptime-3.png)
