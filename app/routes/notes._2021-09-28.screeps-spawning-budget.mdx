...
As promised in the last post, we entered in the Botarena competition and made a valiant effort. I had no real expectation of _winning_, but competition is still an excellent way to improve: you can take notes from your own failures and from everyone else's victories. And there were plenty of both.
...
Let's pretend _that_ didn't happen and instead talk about the economy rewrite.
...
![Illustration of RCL milestones table](/assets/images/screeps-spawning-budget-1.png)
