...
date: October 7, 2020
excerpt: Deploying our private server-tested code to MMO immediately broke our CPU bucket. Time for the CPU Clinic!
category: screeps
---
...
The first question we should ask ourselves is _do we need to be serializing this at all?_ Global resets don't happen often, so can we store it in the Heap and just rebuild it after a reset?
