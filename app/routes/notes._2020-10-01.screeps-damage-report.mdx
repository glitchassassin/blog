...
date: October 1, 2020
excerpt: Tuning is much easier when you have feedback about what's going on.
category: screeps
---

The article below describes the AI in its current state: I'm still expanding and refining my codebase. [Here's the GitHub repo](https://github.com/glitchassassin/screeps) if you'd like to follow along.

![Creeps beginning to venture outside of the starting room](/assets/images/screeps-remote-mining.png)
...
![Sales report example in console](/assets/images/screeps-sales-report.png)
...
![The Sales report as a visual table overlayed on a room](/assets/images/screeps-sales-report-visual.png)
