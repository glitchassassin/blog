...
date: July 15, 2019
excerpt: Exploring the code needed to bind Cucumber and TestCafe into a cohesive unit
category: testing
tags:
  - automation
  - testing
...
Then(
	"I should see that the first Google's result is {string}",
	async function (text) {
		var firstLink = Selector('#rso')
			.find('a')
