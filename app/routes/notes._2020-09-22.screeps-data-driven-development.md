...
excerpt: Making development decisions around data rather than hunches
category: screeps
---
...
![Screeps task management report](/assets/images/screeps-report.png)
...
Then I gave minions "favored tasks" so that builders will prefer BuildTasks, upgraders will prefer UpgradeTasks, etc. I'm not settled on this, however; this seems like a step back from calculating which minion is actually best for the task. Builders and Upgraders have the same creep build, right now, so they _should_ be interchangeable.
...
![Sample Screeps dashboard in Grafana](/assets/images/screeps-stats.png)
