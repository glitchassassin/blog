...
excerpt: Teaching the AI to make strategic decisions with data
category: screeps
---
...
![Screeps energy pipeline dashboard](/assets/images/screeps-pipeline.png)
...
![Current activity in my main Screeps room](/assets/images/W32N39.png)
...
Miners will naturally die off, so we don't need to worry too much about auto-scaling _down_ the miners. This gives us a good start at least: let's test it in simulation and see how it goes. If this piece works, we'll look at auto-scaling workers, once we switch to stationary miners.
